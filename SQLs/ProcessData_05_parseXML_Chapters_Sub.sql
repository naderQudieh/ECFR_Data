 delete from CRF_Sub_Chapters;
 go
INSERT INTO  CRF_Sub_Chapters (Title,ParentNode, Node, SUB_CHAPTER_REF, Head)
SELECT
   ...
   PartNode.value('@NODE', 'NVARCHAR(50)') as 'NodeCode',
    PartNode.value('@N', 'NVARCHAR(20)') as 'SUB_CHAPTER_REF',
    PartNode.value('(HEAD/text())[1]', 'NVARCHAR(500)')  as Head
FROM CRF_XMLRawData
CROSS APPLY XMLData.nodes('/DLPSTEXTCLASS/TEXT/BODY/ECFRBRWS//*[@TYPE="SUBCHAP"]') AS CRF_Parts(PartNode);